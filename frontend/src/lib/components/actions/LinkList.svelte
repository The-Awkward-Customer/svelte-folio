...
<script lang="ts">
  ...
  function handleKeydown(event: KeyboardEvent) {
    const links = Array.from(
      document.querySelectorAll('.link-list-root a:not(.disabled)')
    );
...
<nav class="link-list-root" class:vertical aria-label={ariaLabel}>
