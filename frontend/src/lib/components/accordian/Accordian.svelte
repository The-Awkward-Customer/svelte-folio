<script lang="ts" >
    ...
    import { createAccordionState, toggleAccordion, registerAccordion } from "$lib/stores/accordianManager.svelte.";
    ...
    let { children, number = "1", label = "Replace me" } : AccordianProps = $props();
