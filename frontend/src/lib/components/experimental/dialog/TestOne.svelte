<script lang="ts">
  import {
    ...
    DialogPrinciples,
    DialogTitle,
  } from '$lib/components/overlays/dialog';
  import Image from '$lib/components/overlays/dialog/Image.svelte';
...
>
  <DialogSection id="title" hasPadding={true}>
    <DialogTitle
      title={freshaData.title.title}
      subcopy={freshaData.title.subcopy}
    />
  ...
  <DialogSection id="journey" hasPadding={true}>
    ...
    <DialogText
      title={freshaData.journey.title}
      content={freshaData.journey.content}
    />
  </DialogSection>

  <DialogSection id="graphic one" hasPadding={true}>
    <DialogPrefix variant="subtitle" text={freshaData.graphicOne.prefixText} />
    <Image src={placeholder16x9} alt={freshaData.graphicOne.alt} />
  </DialogSection>

  <DialogSection id="graphic two" hasPadding={true}>
    <DialogPrefix
      variant="subtitle"
      text="flexible component composition is key."
    />
    <Image src={placeholder16x9} alt="placeholder" />
  </DialogSection>
