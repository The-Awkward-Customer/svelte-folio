...
function createWeatherDebugManager() {
  ...
  const actions = {
    ...
    ): MockWeatherScenario | MockLocationScenario | null {
      if (type === 'weather') {
    ...
    getDebugInfo(): object {
      return {
        ...
        hasMockLocation: !!(
          state.mockLocationData.geoLocation || state.mockLocationData.ipInfo
        ),
  ...
  return {
    ...
    get currentMockWeather() {
      return currentMockWeather;
    },
    get currentMockLocation() {
      return currentMockLocation;
    },
    get currentForcedLoading() {
      return currentForcedLoading;
    },
    get currentForcedError() {
      return currentForcedError;
    },
    get isPanelVisible() {
