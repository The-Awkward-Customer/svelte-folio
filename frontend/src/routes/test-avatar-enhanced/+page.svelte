...
<svelte:head>
	...
	<meta name="description" content="Simplified test page for Avatar component glitch animations" />
</svelte:head>

<main class="test-page">
	<header class="test-header">
		<h1>Avatar Glitch Animation Test</h1>
		<p>Testing the Avatar component loading state and GSAP-powered glitch animations</p>
	</header>
